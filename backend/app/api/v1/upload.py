...
async def upload_pdf(
    ...
    try:
        ...
        # For now, we create a job record and dispatch Celery task
        # In production this would also do encryption check, page count, quota check
        ...
        task = translate_pdf_task.delay(
            job_id=0,  # Will be replaced with actual DB job ID
